...
export function ArrayContainer({
  ...
  const [sortingArray] = useData((state) => [state.sortingArray]);
  ...
  if (sortingArray.length >= 8) return <ArrayHolder>{returnValue}</ArrayHolder>;
  else return <ArrayHolder center>{returnValue}</ArrayHolder>;
}
